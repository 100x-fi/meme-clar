;; title: bmeme
;; version: 0.0.1
;; summary: a bounded meme token
;; description: a none-transferable SIP-010 token. The token can only converted to meme token by vesting.
...
(define-public (transfer (amount uint) (from principal) (to principal) (memo (optional (buff 34))))
  (begin
    (asserts! (is-eq (default-to false (map-get? transferer tx-sender)) true) ERR_FORBIDDEN)
